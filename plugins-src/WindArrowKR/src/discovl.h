...
// 둘째 줄 "성격 거만·집착·냉혹·편협" — 델포이 계시(0x40A4C0)와 같은 낱말.
// 셋째 줄 "여급궁합 당당·의지" — 궁합 좋은(선호 2) 여급 성격.
// 둘 다 성좌+혈액형+얼굴로 나오는 성격 선호 8칸에서 나온다(note/MaidMatch-0x477FE0.md).
// 못 재면 두 줄째로 빠진다.
//
...
#define DISCOVL_W  400
#define DISCOVL_LINE_H 19
#define DISCOVL_H  (4 + DISCOVL_LINE_H * 3)

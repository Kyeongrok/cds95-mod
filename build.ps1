...
$PluginTargets = @("HotelUtilKR", "TradeUtilKR", "CharacterUtilKR", "WorldMapKR", "ShipSkinKR", "PatchUtilKR", "ModUtilKR", "QuestModKR", "UpdateUtilKR", "FatigueUtilKR", "HotkeyUtilKR", "HintUtilKR", "MarketUtilKR", "SaveUtilKR", "CityPicKR", "DialogUtilKR", "SkillUtilKR", "BookUtilKR", "ShipInfoKR", "ButtonMakerKR", "LandWarKR", "WindArrowKR", "ModWindowKR", "DiscoveryEditKR", "TavernInfoKR")
